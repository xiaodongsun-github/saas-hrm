                    ...
                    <div class="treeRinfo">
                      <el-dropdown class="item">
                        ...
                        <el-dropdown-menu slot="dropdown">
                          ...
                          <el-dropdown-item>
                            <el-button type="text" @click="handlUpdate(data.id)">查看此部门</el-button>
                          </el-dropdown-item>
                          <el-dropdown-item>
                            <el-button type="text" @click="handleList()">查看待分配员工</el-button>
                          </el-dropdown-item>
  ...
  methods: {
    ...
    handlDelete(parentId) {
      this.$confirm("此操作将永久删除该部门, 是否继续?", "提示", {
        ...
        .then(() => {
          deleteById({ id: parentId }).then(res => {
            this.$message({
              showClose: true,
