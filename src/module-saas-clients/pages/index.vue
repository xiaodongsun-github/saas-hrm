    ...
    <div class="app-container">
      <el-card shadow="never">
        ...
        <el-table :data="dataList" border style="width: 100%">
          ...
          <el-table-column fixed prop="version" label="当前版本" width="150"></el-table-column>
          <el-table-column fixed prop="legalRepresentative" label="联系人" width="150"></el-table-column>
          ...
          <el-table-column fixed prop="createTime" label="申请时间" width="150"></el-table-column>
